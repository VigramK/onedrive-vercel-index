...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'Vigram@7mppfn.onmicrosoft.com',
  ...
  email: 'mailto:k.vigram@hotmail.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/VigramK/onedrive-vercel-index',
    },
  ],
